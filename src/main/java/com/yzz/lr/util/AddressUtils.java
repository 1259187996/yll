...
//            System.out.println("(2) unicode转换成中文后的returnStr : " + returnStr);
    ...
    public static void main(String[] args) {
        ...
        String ip = "218.78.199.130";
        System.out.println(addressUtils.getAddrByIp(ip));
    }
    ...
    public static String getAddrByIp(String ip){
        ...
        String country = JSON.parseObject(json.get("data").toString()).get("country").toString();
        ...
        String county = JSON.parseObject(json.get("data").toString()).get("county").toString();
        String isp = JSON.parseObject(json.get("data").toString()).get("isp").toString();
//        String area = JSON.parseObject(json.get("data").toString()).get("area").toString();
